...
<head>
    <title>Car Rental An Auto mobile Category Flat Bootstrap Responsive Website Template | Dashboard :: w3layouts
    </title>
    <!-- for-mobile-apps -->
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link href="{{ asset('template/css/galleryeffect.css') }}" rel="stylesheet" type="text/css" media="all" />
    <link rel="stylesheet" href="{{ asset('template/css/jquery.flipster.css') }}">
    <link rel='stylesheet' href="{{ asset('template/css/dscountdown.css') }}" type='text/css' media='all' />
...
<body>
        ...
        <div class="header-w3l-agile">
            <div class="header_left">
                <ul>
                    ...
                    <li><a href="{{ Route('login') }}"><span class="glyphicon glyphicon-user"
                                aria-hidden="true"></span>Login</a></li>
                    <li><a href="{{ Route('register') }}"><span class="glyphicon glyphicon-plus"
            ...
            <div class="header-nav">
                <nav class="navbar navbar-default">
                    <div class="navbar-header">
                        ...
                        <h1><a href="index.html"><span class="logo-c">C</span><i class="fa fa-car"
                                    aria-hidden="true"></i>Rental</a>
                            <p class="sub-cap">Drive to Any where</p>
                        </h1>
                    </div>
                    <!-- navbar-header -->
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            <li><a href="index.html" class="hvr-underline-from-center active bn">Dashboard</a></li>
                            <li><a href="#about" class="hvr-underline-from-center scroll bn">About Us</a></li>
                            <li><a href="#service" class="hvr-underline-from-center scroll bn">Deals</a></li>
                            <li><a href="#team" class="hvr-underline-from-center scroll bn">Team</a></li>
                            <li><a href="#gallery" class="hvr-underline-from-center scroll bn">Latest Cars</a></li>
                            <li><a href="#contact" class="hvr-underline-from-center scroll bn">Contact Us</a></li>
                        </ul>
                    </div>
                    <div class="clearfix"> </div>
                </nav>
            ...
            <div class="modal-content">
                ...
                <section>
                    <div class="modal-body">
                        ...
                        <img src="{{ asset('template/images/g1.jpg') }}" alt=" " class="img-responsive" />
                ...
                <div id="owl-demo" class="owl-carousel">
                    <div class="item-owl">
                        <div class="test-review">
                            <img src="{{ asset('template/images/s1.jpg') }}" class="img-responsive" alt="" />
                            <h5>$280</h5>
                        </div>
                    </div>
                    <div class="item-owl">
                        <div class="test-review">
                            <img src="{{ asset('template/images/s2.jpg') }}" class="img-responsive" alt="" />
                            <h5>$420</h5>
                        </div>
                    </div>
                    <div class="item-owl">
                        <div class="test-review">
                            <img src="{{ asset('template/images/s3.jpg') }}" class="img-responsive" alt="" />
                            <h5>$480</h5>
                        </div>
                    </div>
                    <div class="item-owl">
                        <div class="test-review">
                            <img src="{{ asset('template/images/s4.jpg') }}" class="img-responsive" alt="" />
                            <h5>$600</h5>
                        </div>
                    </div>
                    <div class="item-owl">
                    ...
                    <div class="item-owl">
                        <div class="test-review">
                            <img src="{{ asset('template/images/s5.jpg') }}" class="img-responsive" alt="" />
                            <h5>$500</h5>
                        </div>
                    </div>
                    <div class="item-owl">
            ...
            <div class="inner_w3l_agile_grids">
                <div class="col-md-4 agileits_service_grid_btm_left">
                    <div class="agileits_service_grid_btm_left1">
                        ...
                        <img src="{{ asset('template/images/s3.jpg') }}" alt=" " class="img-responsive">
                    </div>
                </div>
                <div class="col-md-4 agileits_service_grid_btm_left">
                    <div class="agileits_service_grid_btm_left1">
                        ...
                        <img src="{{ asset('template/images/s5.jpg') }}" alt=" " class="img-responsive">
                    </div>
                </div>
                <div class="col-md-4 agileits_service_grid_btm_left">
                    <div class="agileits_service_grid_btm_left1">
                        ...
                        <img src="{{ asset('template/images/s1.jpg') }}" alt=" " class="img-responsive">
                    </div>
                </div>
                <div class="clearfix"> </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="inner_w3l_agile_grids">
                <div class="col-md-4 gal-gd wow fadeInLeft animated" data-wow-delay=".5s">
                    <a href="#image-1">
                        <div class="nd-wrap nd-style-8">
                            <img src="{{ asset('template/images/g1.jpg') }}" class="img-responsive" alt=" " />
                ...
                <div class="col-md-4 gal-gd wow fadeInUp animated" data-wow-delay=".5s">
                    <a href="#image-2">
                        <div class="nd-wrap nd-style-8">
                            <img src="{{ asset('template/images/g2.jpg') }}" class="img-responsive" alt=" " />
                            <div class="nd-content">
                                <div class="nd-content_inner">
                                    <div class="nd-content_inner1">
                                        <h4 class="nd-title">Car Rental</h4>
                ...
                <div class="col-md-4 gal-gd wow fadeInRight animated" data-wow-delay=".5s">
                    <a href="#image-3">
                        <div class="nd-wrap nd-style-8">
                            <img src="{{ asset('template/images/g3.jpg') }}" class="img-responsive" alt="" " />
      <div class="   nd-content">
                            <div class="nd-content_inner">
                                <div class="nd-content_inner1">
                                    <h4 class="nd-title">Car Rental</h4>
            ...
            <div class="col-md-6 gal-gd-sec wow fadeInLeft animated" data-wow-delay=".5s">
                <a href="#image-4">
                    <div class="nd-wrap nd-style-8">
                        <img src="{{ asset('template/images/g4.jpg') }}" class="img-responsive" alt=" " />
                        <div class="nd-content">
                            <div class="nd-content_inner">
                                <div class="nd-content_inner1">
                                    <h4 class="nd-title">Car Rental</h4>
            ...
            <div class="col-md-6 gal-gd-sec wow fadeInRight animated" data-wow-delay=".5s">
                <a href="#image-5">
                    <div class="nd-wrap nd-style-8">
                        <img src="{{ asset('template/images/g5.jpg') }}" class="img-responsive" alt="}" " />
      <div class="   nd-content">
                        <div class="nd-content_inner">
                            <div class="nd-content_inner1">
                                <h4 class="nd-title">Car Rental</h4>
        ...
        <div class="col-md-4 gal-gd wow fadeInLeft animated" data-wow-delay=".5s">
            <a href="#image-6">
                <div class="nd-wrap nd-style-8">
                    <img src="{{ asset('template/images/g6.jpg') }}" class="img-responsive" alt=" " />
                    <div class="nd-content">
                        <div class="nd-content_inner">
                            <div class="nd-content_inner1">
                                <h4 class="nd-title">Car Rental</h4>
        ...
        <div class="col-md-4 gal-gd wow fadeInDown animated" data-wow-delay=".5s">
            <a href="#image-7">
                <div class="nd-wrap nd-style-8">
                    <img src="{{ asset('template/images/g7.jpg') }}" class="img-responsive" alt=" " />
                    <div class="nd-content">
                        <div class="nd-content_inner">
                            <div class="nd-content_inner1">
                                <h4 class="nd-title">Car Rental</h4>
        ...
        <div class="col-md-4 gal-gd wow fadeInRight animated" data-wow-delay=".5s">
            <a href="#image-8">
                <div class="nd-wrap nd-style-8">
                    <img src="{{ asset('template/images/g8.jpg') }}" class="img-responsive" alt=" " />
                    <div class="nd-content">
                        <div class="nd-content_inner">
                            <div class="nd-content_inner1">
                                <h4 class="nd-title">Car Rental</h4>
    ...
    <div class="lb-overlay" id="image-1">
        <img src="{{ asset('template/images/g1.jpg') }}" alt="image1" />
        <div class="gal-info">
            <h3>Car Rental</h3>
    ...
    <div class="lb-overlay" id="image-2">
        <img src="{{ asset('template/images/g2.jpg') }}" alt="image1" />
        <div class="gal-info">
            <h3>Car Rental</h3>
            <p>Neque porro quisquam est, qui dolorem ipsum
                quia dolor sit amet, consectetur, adipisci velit,
    ...
    <div class="lb-overlay" id="image-3">
        <img src="{{ asset('template/images/g3.jpg') }}" alt="image1" />
        <div class="gal-info">
            <h3>Car Rental</h3>
            <p>Neque porro quisquam est, qui dolorem ipsum
                quia dolor sit amet, consectetur, adipisci velit,
    ...
    <div class="lb-overlay" id="image-4">
        <img src="{{ asset('template/images/g4.jpg') }}" alt="image1" />
        <div class="gal-info">
            <h3>Car Rental</h3>
            <p>Neque porro quisquam est, qui dolorem ipsum
                quia dolor sit amet, consectetur, adipisci velit,
    ...
    <div class="lb-overlay" id="image-5">
        <img src="{{ asset('template/images/g5.jpg') }}" alt="image1" />
        <div class="gal-info">
            <h3>Car Rental</h3>
            <p>Neque porro quisquam est, qui dolorem ipsum
                quia dolor sit amet, consectetur, adipisci velit,
    ...
    <div class="lb-overlay" id="image-6">
        <img src="{{ asset('template/images/g6.jpg') }}" alt="image1" />
        <div class="gal-info">
            <h3>Car Rental</h3>
            <p>Neque porro quisquam est, qui dolorem ipsum
                quia dolor sit amet, consectetur, adipisci velit,
    ...
    <div class="lb-overlay" id="image-7">
        <img src="{{ asset('template/images/g7.jpg') }}" alt="image1" />
        <div class="gal-info">
            <h3>Car Rental</h3>
            <p>Neque porro quisquam est, qui dolorem ipsum
                quia dolor sit amet, consectetur, adipisci velit,
    ...
    <div class="lb-overlay" id="image-8">
        <img src="{{ asset('template/images/g8.jpg') }}" alt="image1" />
        <div class="gal-info">
            <h3>Car Rental</h3>
            <p>Neque porro quisquam est, qui dolorem ipsum
                quia dolor sit amet, consectetur, adipisci velit,
        ...
        <div class="container">
            ...
            <div class="col-md-2 footer-grid">
                ...
                <ul>
                    ...
                    <li><a class="scroll" href="#home">Dashboard</a></li>
            ...
            <div class="col-md-4 footer-grid">
                ...
                <div class="footer-grid1">
                    <div class="footer-grid1-left">
                        <a href="#"><img src="{{ asset('template/images/s3.jpg') }}" alt=" "
                ...
                <div class="footer-grid1">
                    ...
                    <div class="footer-grid1-left">
                        <a href="#"><img src="{{ asset('template/images/s1.jpg') }}" alt=" "
                                class="img-responsive"></a>
                    </div>
                    <div class="footer-grid1-right">
            ...
            <div class="col-md-3 footer-grid">
                ...
                <div class="footer-grid-instagram">
                    <a href="#"><img src="{{ asset('template/images/s3.jpg') }}" alt=" " class="img-responsive"></a>
                </div>
                <div class="footer-grid-instagram">
                    <a href="#"><img src="{{ asset('template/images/s4.jpg') }}" alt=" " class="img-responsive"></a>
                </div>
                <div class="footer-grid-instagram">
                    <a href="#"><img src="{{ asset('template/images/s5.jpg') }}" alt=" " class="img-responsive"></a>
                </div>
                <div class="footer-grid-instagram">
                    <a href="#"><img src="{{ asset('template/images/s1.jpg') }}" alt=" " class="img-responsive"></a>
                </div>
                <div class="clearfix"> </div>
            </div>
            <div class="clearfix"> </div>
    ...
    <script type="text/javascript" src="{{ asset('template/js/dscountdown.min.js') }}"></script>
    <script src="{{ asset('template/js/demo-1.js') }}"></script>
    <script>
    ...
    <script src="{{ asset('template/js/jquery.flipster.js') }}"></script>
    <script>
        $(function() {
            $(".flipster").flipster({
                style: 'carousel',
